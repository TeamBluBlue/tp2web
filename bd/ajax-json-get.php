...
include_once("../include/param-bd.inc.php");
...
try {
	...
	echo "\t\"erreur\": "."\"Erreur lors de la connexion à la BD : ".$e->getMessage()."\"";
}
...
try{
	...
	echo "\t\"erreur\": "."\"Erreur lors de la récupération des ZAP : ".$e->getMessage()."\"\n";
}
...
try{
	...
	echo "\t\t\"erreur\": "."\"Erreur lors de l'exportation JSON des ZAP : ".$e->getMessage()."\"\n";
	echo "\t}\n";
} catch (Exception $ex) {
	echo "\t\t\"erreur\": "."\"Erreur inattendue lors de l'exportation JSON des ZAP : ".$ex->getMessage()."\"\n";
	echo "\t}\n";
}
